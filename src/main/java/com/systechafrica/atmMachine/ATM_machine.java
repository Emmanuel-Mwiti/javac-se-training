...
public class ATM_machine {
  public static void main(String[] args) {
    ...
    // 5. Now after all the logistics, the system should not be existing after each option, it should be taking us 
    //    to the main menu.
    //    So, i will encompass the whole ATM menu under true evaluation such that it evaluates true. Also, 
    //    it should reload the main option, therefore, i will remove it from the place of checking user 
    //    and password to the first welcome message. Few Modifications also to only print login successiful once.
    // 6. Enable the quite to work by adding a System.quit or return in case 5. Als0, to prevent the if 
          //  checking the logins to continue execution, you exist from the whole function using return 
          //  or system.ext
