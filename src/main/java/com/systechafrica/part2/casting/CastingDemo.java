...
public class CastingDemo {
  public static void main(String[] args) {
    ...
    Animal animal = new Dog();// ?This is implicit upcasting- Also called narrowing
    app.printInfo(animal);// ? This will print because we have the done explicit
    // downcasting
    Animal animal2 = new Cat();
    app.printInfo(animal2);
    // animal.printName();//!This one does not compile because we have done
